            ...
            <div class="otp-bg">
                <div class="otp-modal">
                    ...
                    <div class="otp-modal-body">
                        ...
                        <input class="otp-input-body" type="text" name="${name}" maxlength="2${length}" autocorrect="off" autocomplete="off" style="max-width:${52.125*length}px"/>
