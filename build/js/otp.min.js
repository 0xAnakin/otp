!function($){let defaults={name:"otp",length:4,animation:{fade:600,position:600},fetch:{requestOTP:{url:"http://localhost:3001/api/request.json",options:{method:"GET",headers:{"Content-Type":"application/json"}}},validateOTP:{url:"http://localhost:3001/api/validate.json",options:{method:"GET",headers:{"Content-Type":"application/json"}}}},i18n:{title:"Σύνδεση",subtitle:"Παρακαλώ εισάγετε τον κωδικό<br/>μιας χρήσης που σας έχει αποσταλλεί.",label:"Κωδικός μια χρήσης",resend:"Πατήστε εδώ για αποστολή νέου κωδικού.",validate:"ΣΥΝΕΧΕΙΑ",expired:"O κωδικός που στάλθηκε έχει λήξει.<br/>",invalid:"O κωδικός δεν είναι σωστός."},events:{onRequest:function(res){var res=res.duration,compensation=(Date.now()-this.requested)/2;this.duration=res,this.expires=new Date(this.requested+(this.duration-compensation)).getTime()},onValidate:function(res){return"valid"in res&&!0===res.valid}}};$.fn.OTP=function(options=defaults){let charArr=[],instance={},{name,length,i18n,animation}=options;var{title,subtitle,label,expired,invalid,resend,validate}=i18n;function onSubmit(evt){evt.preventDefault(),evt.stopImmediatePropagation(),instance.show()}return instance.interval=null,instance.duration=null,instance.requested=null,instance.expires=null,instance.options=options,instance.active=!1,instance.$otp=$(`
