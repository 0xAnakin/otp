!function($){let defaults={name:"otp",length:4,fetch:{requestOTP:{url:"http://localhost:3001/api/request.json",options:{method:"GET",headers:{"Content-Type":"application/json"}}},validateOTP:{url:"http://localhost:3001/api/validate.json",options:{method:"GET",headers:{"Content-Type":"application/json"}}}},i18n:{title:"Σύνδεση",label:"Κωδικός μια χρήσης",help:"Παρακαλώ εισάγετε τον κωδικό μιας χρήσης που σας έχει αποσταλλεί.",resend:"ΕΠΑΝΑΠΟΣΤΟΛΗ",validate:"ΣΥΝΕΧΕΙΑ"},events:{onRequest:function(res){var res=res.duration,compensation=(Date.now()-this.requested)/2;this.duration=res,this.expires=new Date(this.requested+this.duration-compensation).getTime()},onValidate:function(res){return"valid"in res&&!0===res.valid}}};$.fn.OTP=function(options=defaults){let charArr=[],instance={},{name,length,i18n}=options;var{title,label,help,resend,validate}=i18n;return instance.interval=null,instance.duration=null,instance.requested=null,instance.expires=null,instance.options=options,instance.active=!1,instance.$otp=$(`
